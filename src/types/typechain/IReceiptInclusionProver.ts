...
export interface IReceiptInclusionProverInterface extends utils.Interface {
  functions: {
    "proveReceiptInclusion(((bytes32,bytes32,address,bytes32,bytes32,bytes32,bytes,uint256,uint256,uint256,uint256,uint256,bytes,bytes32,uint256),(bool,uint256,bytes,(address,bytes32[],bytes)[]),uint256,bytes32[]))": FunctionFragment;
  };
...
export interface IReceiptInclusionProver extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IReceiptInclusionProverInterface;
